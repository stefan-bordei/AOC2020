...
passports = [chunk.split() for chunk in open("./data/4_input.txt").read().split("\n\n")]

print("Part1: ", len([True for p in passports if is_valid_passport(p)]))
print("Part2: ", len([True for p in passports if is_valid_passport_param(p)]))
