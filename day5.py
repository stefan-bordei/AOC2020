...
def infoValidator(data):
    ...
    ans1 = max(seatList)
    seats = sorted(seatList)
    ans2 = find_missing(seats)
    return "Ans part 1: " + str(ans1), "Ans part 2: " + str(ans2[0])

print(infoValidator("./data/5_input.txt"))
